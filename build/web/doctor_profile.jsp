...
<html lang="en">
    ...
    <%
        ...
        try {
            ...
            user_email = request.getParameter("result1");
            ...
            while (rs.next()) {
                ...
                online = rs.getString("online_checkup");
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        ...
                        <li class="nav-item nav-profile dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                                <a class="dropdown-item" href="patient_profile.jsp?result=<%=user_email%>">
                                    ...
                                    <div class="card-body">
                                        <nav class="navbar navbar-light bg-light">
                                            <div class="container-fluid">
                                                <h2>Dr. <%=fname%> <%=lname%></h2>
                                                <img src="images/dashboard/rating1" style="height: 50px;width: 150px;">
                                                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                                                    <img src="<%=photo%>" style="width: 50px;height: 50px;border-radius: 30%" alt="profile">
                                                </a>
                                            </div>
                                            <br><br><br><br><br><br>
                                            ...
                                            <div class="info">
                                                ...
                                                <h4 class="font-weight-500 mb-xl-4 text-primary mb-2 mb-xl-0"><%=year%> year experience</h4>
                                                <h4 class="font-weight-500 mb-xl-4 text-primary mb-2 mb-xl-0"><%=category%></h4>
                                                <h4 class="font-weight-500 mb-xl-4 text-primary mb-2 mb-xl-0">DOB : <%=dob%></h4>
                                                <h4 class="font-weight-500 mb-xl-4 text-primary mb-2 mb-xl-0">City : <%=city%></h4>
                                                ...
                                                <h4 class="font-weight-500 mb-xl-4 text-primary mb-2 mb-xl-0">Total Patient Checkup till now : <%=total%></h4>
                                                <h4 class="font-weight-500 mb-xl-4 text-primary mb-2 mb-xl-0">Online Patient Checkup : <%=online%></h4>
                                                <h4 class="font-weight-500 mb-xl-4 text-success mb-2 mb-xl-0">Detail : <%=detail%></h4>
                                                <h4 class="font-weight-500 mb-xl-4 text-danger mb-2 mb-xl-0">Description : <%=description%></h4>
                                            </div>
                                            <br>

                                            <a href="payment.jsp?result=<%=email%>&result1=<%=user_email%>&path=<%=path%>"><button type="button" class="btn btn-danger">Confirm Book</button></a>    
                                            <button type="button" class="btn btn-success">Charge - <%=fee%>rs</button>
                                        </nav>
                                    </div>    
                                </div>
                            </div>
