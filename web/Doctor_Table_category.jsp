...
<html lang="en">
    ...
    <%
        ...
        String res1 = request.getParameter("result1");
        String c_id = "";
        String final_category = "";
        c_id = request.getParameter("result");
        if ("1".equals(c_id)) {
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        ...
                        <li class="nav-item nav-profile dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
                                <a class="dropdown-item" href="patient_profile.jsp?result=<%=res1%>">
                    ...
                    <div class="content-wrapper">
                        <div class="row">
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title"><%=final_category%></h4>
                                                ...
                                                <tbody>
                                                    <%
                                                        ...
                                                        try {
                                                            ...
                                                            String query = "select * from doctor_register where category='" + res + "';";
                                                            PreparedStatement ps = (PreparedStatement) cnn.prepareStatement(query);
                                                            ResultSet rs = ps.executeQuery();
                                                            String query1 = "SELECT COUNT(*) FROM doctor_register where category='" + res + "';";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="doctor_profile.jsp?result=<%=email%>&result1=<%=user_email%>&path=<%=path%>"><button type="button" class="btn btn-danger">Book</button></a>
                                                        </td>
                                                        <td>
                                                            <%=year%>
                                                        </td>
